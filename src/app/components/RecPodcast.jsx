            ...
            <div className='py-8'>
                ...
                <div className="grid grid-cols-1 mx-auto max-w-7xl md:grid-cols-3">
                    ...
                    <div className='bg-white p-6 rounded-lg border border-slate-300 shadow-md m-2 flex flex-col justify-start items-start hover:shadow-lg hover:scale-105 transition-all duration-300'>
                        ...
                        <p className='text-sm text-slate-800 text-left pb-4'> Oriente os estudantes a criarem, em duplas, um podcast sobre a importância de evitar desperdícios. Se necessário, revisitem os capítulos 4 e 5. Peça para que explorem o tema, pensando em termos individuais (explicando a importância de um orçamento, por exemplo), e em termos ambientais (mostrando o impacto que o mau uso da água e da eletricidade pode causar).</p>
                    </div>
                    ...
                    <div className='bg-white p-6 rounded-lg border border-slate-300 shadow-md m-2 flex flex-col justify-start items-start hover:shadow-lg hover:scale-105 transition-all duration-300'>
                        ...
                        <p className='text-sm text-slate-800 text-left pb-4'>Os estudantes podem optar por entrevistar familiares, para ter a noção do que essas pessoas sabem ou pensam sobre esse assunto. Para isso, devem formular perguntas claras e objetivas a respeito do tema, como por exemplo: Como evitar desperdícios? Como economizar nas compras de mercado?</p>
                    </div>
